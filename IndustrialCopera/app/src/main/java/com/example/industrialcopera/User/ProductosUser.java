 ...
 * Use the {@link ProductosUser#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ProductosUser extends Fragment {
     ...
     * @return A new instance of fragment ProductosUser.
     */
    // TODO: Rename and change types and number of parameters
    public static ProductosUser newInstance(String param1, String param2) {
        ProductosUser fragment = new ProductosUser();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_productos_user, container, false);
    }

    List<Producto> productos;
    RecyclerView rv;
    AdapProductoUser adaptador;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rv=(RecyclerView)view.findViewById(R.id.RV_User_Productos);
        productos=new ArrayList<Producto>();

        rvL=new StaggeredGridLayoutManager(2,1);
        rv.setLayoutManager(rvL);
        adaptador=new AdapProductoUser(ma,productos);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if(productos.isEmpty()){
                            ...
                            for(final Producto co:productos){
