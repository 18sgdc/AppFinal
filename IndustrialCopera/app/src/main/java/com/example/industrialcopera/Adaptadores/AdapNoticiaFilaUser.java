...
public class AdapNoticiaFilaUser extends RecyclerView.Adapter<AdapNoticiaFilaUser.Vh> {
    ...
    public AdapNoticiaFilaUser(ActivityUsuario ma, List<Concierto> conciertos) {
        this.ma=ma;
